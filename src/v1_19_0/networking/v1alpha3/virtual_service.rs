...
// kopium command: kopium -Af resources/istio/v1_19_0/networking/v1alpha3/VirtualService.yaml --api-version v1alpha3 -D Default
...
pub struct VirtualServiceHttpMirrors {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub destination: Option<VirtualServiceHttpMirrorsDestination>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
